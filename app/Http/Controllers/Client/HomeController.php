...
class HomeController extends Controller
{
    ...
    { 
        ...
        if($body->success && $body->score >= 0.5){
                ...
                // $adminEmail = "juandaent@gmail.com";
                // Mail::raw('Hi, welcome user!', function ($message) {
                //   $message->to('juandaent@gmail.com')
                //     ->subject('tes')
                //     ->setBody('<h1>Hi, welcome user!</h1>', 'text/html');
                // });
                // Mail::to($adminEmail)->bcc(['khoeruladhayana@gmail.com','putriaisyah245@gmail.com','marketing@bnmstainless.co.id', 'patrajuanda10@gmail.com'])->send(new ContactMail());
