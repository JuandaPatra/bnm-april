...
<head>
   ...
   <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-KEZ434732K"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-KEZ434732K');
    </script>
...
<script>
    $(document).ready(function() {
        ...
        // $('#inputM').trigger('touchstart');

        // $('#inputM').on('touchstart', function() {
        //     $(this).focus();
        
        // })
        
        // const button = document.getElementById("button");
        // const input = document.getElementById("inputM");
        ...
        //     }
        // })
        $('.phone-limit').on('keypress',  function(e){
            if(this.value.length > 12){
                return false
            }
        })
        ...
        $('.phone-limit').on('keydown',  function(e){
            var invalidChars = [
                    "-",
                    "+",
                    "e",
        ...
        // });
         ...
         $('#submitM').on('click tap touchstart', function(e) {
            ...
            if($('#flexCheckDefaultM').val() === 'TRUE'){
                if ($('#flexCheckDefaultM').val() === 'TRUE' && $('#fullnameM').val().length !== 0 && $('#businessaddressM').val().length !== 0 && $('#companyM').val().length !== 0 && $('#emailM').val().length !== 0 && $('#titleM').val().length !== 0 && $('#phoneM').val().length >1 && $('#messageM').val().length !== 0 ) {
                    ...
                    grecaptcha.ready(function() {
                      grecaptcha.execute('6LcOq_keAAAAAF4AweLemkoyeCEvL5m2fyKjXwHM', {action: 'submit'}).then(function(tokenCapctha) {
                        ...
                        e.preventDefault();
                } else if($('#flexCheckDefaultM').val() === 'FALSE' && $('#fullnameM').val().length === 0 && $('#businessaddressM').val().length === 0  && $('#emailM').val().length === 0 && $('#titleM').val().length === 0 && $('#phoneM').val().length === 0 && $('#messageM').val().length === 0 && $('#companyM').val().length === 0 ) {
                    console.log($('#companyM').val())
                    console.log($('#companyM').val().length)
                    if($('#companyM').val().length === 0){
                        $(console.log('test'))
                    }
        ...
        $('#submit').on('click', function(e){
            ...
            if ($('#flexCheckDefault').val() === 'TRUE') {
                if ($('#fullname').val().length !== 0 && $('#message').val().length !== 0 && $('#businessaddress').val().length !== 0 && $('#company').val().length !== 0 && $('#email').val().length !== 0 && $('#title').val().length !== 0 && $('#phone').val().length !== 0 && isEmail(email) && $('#flexCheckDefault').val() === 'TRUE' ) {
                ...
                else if($('#fullname').val().length === 0  || $('#company').val().length === 0 || $('#message').val().length === 0 || $('#businessaddress').val().length === 0 || $('#email').val().length === 0 || $('#title').val().length === 0 || $('#phone').val().length === 0 || !isEmail(email) || $('#flexCheckDefault').val() === 'FALSE' || !grecaptcha.getResponse()){
