...
Route::get('/mail', function(){
      // Mail::raw('Hello World!', function($msg) {$msg->to('khoeruladhayana@gmail.com')->subject('Test Email'); });

    Mail::getSwiftMailer()->registerPlugin (
        new Swift_Plugins_LoggerPlugin(new Swift_Plugins_Loggers_EchoLogger(false))
    );
    $to = 'khoeruladhayana@gmail.com';
    Mail::raw('TestmailFromHosting', function ($message) use($to) {  
