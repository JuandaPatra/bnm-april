...
<header class="position-relative">
    ...
    <img src="{{asset('/images/bnm/components/header/news-banner-mobile.png')}}" alt="" style="width: 100%;object-fit: cover;height:auto" class=" forMobile">
    <div class="desc-first news">
        <h1 class="title forDesktop">NEWS</h1>
