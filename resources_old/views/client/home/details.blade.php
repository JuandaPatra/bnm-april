    ...
    <header class="position-relative" id="home">
        ...
        <div class="desc-second pop-head " data-header=1 data-img="head-1.jpg" data-popSlide="1">
            <div class="d-flex justify-content-center">
                ...
                <div class="caption forDesktop">
                    {{ $postsBanner[0]->title }}
                </div>
                <div class="caption forMobile">
                    <?php
                        echo str_replace("Stainless","<br/> Stainless",$postsBanner[0]->title);
                    ?>
                </div>
            </div>
        </div>
        ...
        <div class="desc-fourth pop-head " data-header=3 data-img="head-3.png" data-popSlide="3">
            <div class="d-flex justify-content-center">
                ...
                <div class="caption forMobile">
                    <?php
                        echo str_replace("Manufacturing","<br/> Manufacturing",$postsBanner[2]->title);
                    ?>
                </div>
            </div>
        </div>
            ...
            <div class="mx-auto">
                <div class="text-center">
                    ...
                    <div class="forDesktop">
                        ...
                        {!! $categorySustanbility->description !!}
                    </div>
                    <div class="forMobile">
                                ...
                                <div class=" impact-box-slider row gx-2">
                                        ...
                                        <div class="col-12 col-md-4 ">
                                            <div class="impact-box">
                                                <img src="{{ $row->thumbnail }}" alt="energy" class="impact-img">
                                            </div>
                                        </div>
                                        @endforeach
                                </div>
                ...
                <div class="col-10 col-lg-10">
                    <div class="row gx-0">
                        <div class="col-12 col-lg-6 ">
                            ...
                            <p class="ministry">
                                The Ministry of Trade <br> of the Republic of Indonesia
                            </p>
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            <p>
                               We become partners with our customers by manufacturing and providing tailor-made solutions exclusively to their needs.
                            </p>
        ...
        <div class="container-full">
                ...
                <div class="col-10 col-md-11">
                    <div class="row gx-0">
                        <div class="col-md-4">
                            ...
                            <p class="mt-5 ">
                               We welcome all talented individuals with a passion to learn, to contribute at BNM Stainless Steel &#8212;  a mindfulness-based business that continuously nurture its employees to have an interdependent co-arising perspective.

                            </p>
                            <div class="contain-btn-job">
                                <a class="btn btn-job rounded-pill btn-lg" href="/career">
                                    See Job Openings
                                </a>
                            </div>
                        </div>
            ...
            <div class="forMobile">
                <div class="row gx-0">
                    ...
                    <div class="col-10">
                        <div class="d-flex justify-content-center">
                            <a href="/career" class="btn-job-m rounded-pill btn-lg">
                                See Job Openings
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="w-85 0 bg-white p-5 box-popupheader">
                            ...
                            <div class="row gx-3 popupheader-body-container">
                                ...
                                <div class="col-lg-4 mt-3 popupheader-body-right">
                                    ...
                                    <!-- <div id="p-body" class="forMobile">{!! $row->content !!} </div> -->
                                </div>
                            </div>
