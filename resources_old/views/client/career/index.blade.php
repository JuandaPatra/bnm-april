    ...
    <section class="job__section">
        <div class="container-full">
            ...
            <div class="tableFull forDesktop">
                <div class="container">
                    <table class="table table-xl" id="jobtable">
                        ...
                        <tbody>
                            @if($career->count() == 0)
                                    <tr class="job-listm" data-position="" data-date="" data-loc="" data-division="" data-employee="" data-requirement="" data-image="{{asset('/images/bnm/header/career-popup.jpg')}}">
                            ...
                            @else
                                @foreach ($career as $row)
                                	<tr class="job-list" data-position="{{ $row->slug }}" data-date="<?php
            ...
            <div class="px-5 job-mobile forMobile">
                ...
                @else
                 @foreach ($career as $row)
                	<div class="job-list py-5 border-bottom" data-position="{{ $row->slug }}" data-date="<?php
                            $dateTime = new DateTime($row->due_date);
       ...
       <div class="body forDesktop">
            <div class="d-flex justify-content-center popSlider">
                <div class="w-85 bg-white ">
                    <div class="d-flex justify-content-end  px-3 py-3 mb-5">
                            ...
                            <div class="row gx-0 ">
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="d-flex justify-content-end">
                                        <img src="{{asset('/images/bnm/header/career-popup.jpg')}}" alt="" class="w-85 h-75" id="p-img">
                                    </div>
                                </div>
