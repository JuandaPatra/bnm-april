        ...
        <div class="offcanvas-header me-3 d-flex justify-content-between">
            <a class="navbar-brand" href="/">
                <div class="d-flex ">
                    ...
                    <!-- <img src="{{asset('/images/bnm/navbar/ptbnm.png')}}" alt="" class="logo-caption forDesktop"> -->
    ...
    <div class="forDesktop">
        <div class="offcanvas-body mt-3">
            <div class="dropdown mt-3">
                ...
                <!--        Indonesia-->
                <!--    </a>-->
                <!--    <div class="vl lang"></div>-->
                <!--    <a href="" class="btn btn-transparent fw-bolder">English</a>-->
                <!--</div>-->
            </div>
        </div>
    </div>
...
<script>
    // window.visualViewport.addEventListener('resize', event => alert(event.target));
    ...
    window.addEventListener("resize", function() {
      if(window.innerHeight == fullWindowHeight) {
        ...
        // alert(keyboardIsProbablyOpen)
        // document.getElementById("offcanvasExample").style.top = "0";
        document.querySelector(".offcanvas.offcanvas-end").style.top = 0;
        // document.querySelector(".offcanvas.offcanvas-end").style.color  = "red";
        ...
        // document.querySelector(".offcanvas-end").style.color  = "magenta";
      }
    });
