                ...
                <div class="position-relative">
                    <div class="position-absolute box-style">
                        <div class="contact-box">
                            ...
                            <form method="POST" action="/demo/contact-form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="d-flex  border-bottom margin-r-3-5">
                                    ...
                                    <button class="border-0 bg-transparent send-button" id="submit">
                ...
                <div class=" p-5">
                    <div class=" message-form">
                        ...
                        <form method="POST" action="/demo/contact-form" enctype="multipart/form-data">
                            ...
                            <div class="row gx-0">
                                <div class="col-12">
                                    <div class="mb-2 pe-4 group-input">
                                        <label for="fullnameM" class="form-label">Full Name</label>
                                    ...
                                    <div class="mb-2 pe-4 group-input">
                                        <label for="companyM" class="form-label">Company</label>
                                ...
                                <div class="col-12">
                                    <div class="mb-2 pe-4 group-input">
                                     ...
                                     <div class="mb-2 pe-4 group-input">
                                        <label for="businessaddressM" class="form-label">Business Address</label>
                                    ...
                                    <div class="mb-2 pe-4 group-input">
                                        <label for="phoneM" class="form-label">Phone</label>
                            ...
                            <div class="d-flex border-bottom " style="margin-right:2rem">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="FALSE" id="flexCheckDefaultM">
